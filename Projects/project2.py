...
summer_points = 0
fall_points = 0
answer1 = input("would you rather have it A Rain B Snow C Cloudy or D Be sunny")
if answer1 == "A":
    spring_point += 1 
elif answer1 =="B":
    winter_points += 1
...
answer2 = input("what is your favorite activity A jump in puddles B ski or snowboard C rake leaves or D swim")
if answer2 == "A":
    spring_point+= 1
elif answer2 == "B":
        winter_points += 1
...
answer3 = input(" do you prefer A short sleeves B sweatshirt C long sleave or D tank top")
if answer3 =="A":
        spring_point += 1
elif answer3 == "B":
        winter_points += 1
...
if answer4 == "A":
      ...
      winter_points += 1
      fall_points += 1
answer5 = input(" do you like A baseball B skiing C soccer or D golf ")
if  answer5 == "A":
      spring_point += 1
elif answer5 == "B":
    winter_points += 1 
